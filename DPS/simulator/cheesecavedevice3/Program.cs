...
namespace X509CertificateSimulatedDevice
{
    class Program
    {
        ...
        private static string dpsIdScope = "0ne00132171";

        // Certificate (PFX) File Name.
        private static string s_certificateFileName = "C:\\Users\\srkothal\\source\\repos\\azure-iot\\DPS\\certificates\\certs\\cheesecave-device3.cert.pfx";
