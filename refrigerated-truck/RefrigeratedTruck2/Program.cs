...
namespace RefrigeratedTruck
{
    class Program
    {
        ...
        static string truckIdentification = "RefrigeratedTruck" + truckNum;
        ...
        // User IDs.
        static string ScopeID = "0ne00121F70";
        static string DeviceID = "RefrigeratedTruck2";
        static string PrimaryKey = "nqacAbmJdizdqrXBXWhzAtWwzTpaTWpXWl0uBqJl6zE=";
        static string AzureMapsKey = "UWTc0_GaT6IE44u3uduKZpKIlmLyO0r0yrce1edKRfo";
