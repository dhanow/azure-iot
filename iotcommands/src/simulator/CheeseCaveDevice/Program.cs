...
namespace simulated_device
{
    class SimulatedDevice
    {
        ...
        private readonly static string s_deviceConnectionString = "HostName=sridhariothub.azure-devices.net;DeviceId=CheeseCaveID;SharedAccessKey=be4i9W/S1enxDEYRZJVaHm6ExnHXmbaQpNZIWB/CMFQ=";
        ...
        // The fan has three states: on, off, and failed. The method above sets the fan to either of the first two of these states. 
        // If the payload text doesn't match one of these two, or the fan is in a failed state, an error is returned.
