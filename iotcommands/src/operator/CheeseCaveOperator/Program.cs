...
namespace cheesecave_operator
{
    class ReadDeviceToCloudMessages
    {
        ...
        //Endpoint=sb://iothub-ns-sridhariot-3769999-3195c2a6e0.servicebus.windows.net/;SharedAccessKeyName=iothubowner;SharedAccessKey=Pe0bXqiof+NfLs5P+XbBedAYSK9vvjsQccc3TRUKvgs=;EntityPath=sridhariothub
        private readonly static string s_eventHubsCompatibleEndpoint = "sb://iothub-ns-sridhariot-3769999-3195c2a6e0.servicebus.windows.net/";

        // The Event Hub-compatible name.
        //NOTE: EXTRACT THE BELOW VALUES FROM THE ENDPOINT URL OR USING CLI
        private readonly static string s_eventHubsCompatiblePath = "sridhariothub";
        private readonly static string s_iotHubSasKey = "Pe0bXqiof+NfLs5P+XbBedAYSK9vvjsQccc3TRUKvgs=";
        private readonly static string s_iotHubSasKeyName = "iothubowner";
        private static EventHubClient s_eventHubClient;

        // Connection string for your IoT Hub.
        private readonly static string s_serviceConnectionString = "HostName=sridhariothub.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=Pe0bXqiof+NfLs5P+XbBedAYSK9vvjsQccc3TRUKvgs=";
