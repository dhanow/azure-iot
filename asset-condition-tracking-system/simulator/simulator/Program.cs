...
namespace device_simulation
{
    class DeviceSimulation
    {
        ...
        private readonly static string connectionString_Truck = "HostName=sridhariothub-test.azure-devices.net;DeviceId=TruckDevice;SharedAccessKey=YUYwybPuvE3AjuQ4veC6kluGgyccx4/brQkYlWtcgwc=";
        private readonly static string connectionString_Airplane = "HostName=sridhariothub-test.azure-devices.net;DeviceId=AirplaneDevice;SharedAccessKey=rDJx+XmPdhe5x6abOh0knwI9O5aC+SnO41Y8xac2mho=";
        private readonly static string connectionString_Container = "HostName=sridhariothub-test.azure-devices.net;DeviceId=ContainerDevice;SharedAccessKey=HHE5WIsN4v04JWFA3xBq+hGD9jnhckZEwjS1/Cu9so4=";
